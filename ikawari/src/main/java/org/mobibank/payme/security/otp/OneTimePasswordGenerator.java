package org.mobibank.payme.security.otp;
...
public class OneTimePasswordGenerator {
     ...
     */
    public OneTimePasswordGenerator() throws NoSuchAlgorithmException {
     ...
     * happen except in cases of serious misconfiguration
     */
    public OneTimePasswordGenerator(final int passwordLength) throws NoSuchAlgorithmException {
     ...
     */
    public OneTimePasswordGenerator(final int passwordLength, final String algorithm) throws NoSuchAlgorithmException {
