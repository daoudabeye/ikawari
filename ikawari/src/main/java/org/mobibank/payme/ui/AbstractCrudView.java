...
public abstract class AbstractCrudView<T extends AbstractEntity> implements Serializable, View, HasLogger {
	 ...
	 * 
	 */
	public static final String CAPTION_DISCARD = "Ignoré";
	public static final String CAPTION_CANCEL = "Annuler";
	public static final String CAPTION_UPDATE = "Modifer";
	public static final String CAPTION_ADD = "Ajouter";
