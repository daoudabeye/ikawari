package org.mobibank.payme.ui.view.envoi;
...
import org.mobibank.payme.ui.components.TransfertGrid;
import org.mobibank.payme.ui.navigation.NavigationManager;
import org.mobibank.payme.ui.view.envoi.ordres.OrdreEditView;
...
/**
 * The appfront view showing upcoming orders.
 * <p>
...
@SpringView
@Secured({Role.ADMIN, Role.DISTRIBUTEUR, Role.OPERATEUR})
public class TransfertsView extends TransfertsViewDesign implements View {
	...
	@Autowired
	public TransfertsView(NavigationManager navigationManager) {
	...
	public void selectedOrder(Transfert transfert) {
		navigationManager.navigateTo(OrdreEditView.class, transfert.getId());
	}
	
	public void newOrder() {
		navigationManager.navigateTo(EnvoiView.class);
	}
